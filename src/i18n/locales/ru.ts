...
export const ru: Translations = {
  ...
  shortcuts: {
    ...
    settings: 'Настройки горячих клавиш',
    description: 'Выберите модификатор без конфликта для группы горячих клавиш.',
    modifier: 'Модификатор',
    preview: 'Предпросмотр',
    reset: 'Сбросить',
    captureCustom: 'Нажмите комбинацию клавиш...',
    captureHint: 'Удерживайте модификаторы, затем нажмите любую клавишу',
    full: 'Полный',
    home: 'Домой',
    back: 'Назад',
    recents: 'Недавние',
