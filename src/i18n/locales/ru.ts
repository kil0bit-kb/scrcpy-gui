...
export const ru: Translations = {
  ...
  header: {
    ...
    languageLabel: 'Язык',
    usbDebuggingTitle: 'Включите отладку по USB',
    usbDebuggingDesc: 'На вашем Android-устройстве перейдите в Настройки > Для разработчиков и включите отладку по USB.',
    connectDeviceTitle: 'Подключите ваше устройство',
    connectDeviceDesc: 'Подключите через USB-кабель или используйте беспроводную отладку для сопряжения по Wi-Fi.',
    otgModeTitle: 'Режим HID / OTG',
    otgModeDesc: 'Включите проброс клавиатуры или мыши для прямого аппаратного управления без установки приложения сервера scrcpy.',
